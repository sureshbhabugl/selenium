...
public class PersonalLoanTestCases {
	...
	@Test(groups= {"smoke"})
	public void webLoginTest(String URL, String APIKey, String password) {
		System.out.println("-----------------------Value of the parameter: "+URL);
		System.out.println("-----------------------Value of the API parameter: "+APIKey);
		System.out.println("-----------------------Value of the Password parameter: "+password);
